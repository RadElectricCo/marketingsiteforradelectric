    ...
    <div className="relative bg-gradient-to-r from-black to-[#111111] text-white">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 md:py-32 lg:py-36">
        <div className="max-w-3xl">
          ...
          >
            <Zap className="w-6 h-6 sm:w-8 sm:h-8 text-[#D4AF37] drop-shadow-lg" />
            <span className="text-[#D4AF37] text-sm sm:text-base lg:text-lg font-semibold drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)]">
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 drop-shadow-[0_4px_12px_rgba(0,0,0,0.9)] leading-tight"
          >
